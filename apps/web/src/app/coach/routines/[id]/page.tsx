...
export default async function CoachRoutineDetailPage({
  params,
}: {
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto">
      ...
      <div className="flex items-start justify-between mb-6 gap-4">
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 rounded-xl bg-[var(--color-muted)] flex items-center justify-center flex-shrink-0">
            <Dumbbell size={20} className="text-[var(--color-coach)]" />
          </div>
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              ...
              {routine.is_template && (
                <span className="inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full bg-[var(--color-coach-light)] text-[var(--color-coach)] border border-[var(--color-coach)]/20">
                  Plantilla
                </span>
              )}
            </div>
      ...
      {/* Exercise CRUD — client component, shared with admin */}
