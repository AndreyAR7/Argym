  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <RoutineSearch defaultValue={search} basePath="/coach/routines" />
              ...
              {routines.map((routine) => (
                <tr key={routine.id} className="hover:bg-[var(--color-muted)] transition-colors">
                  <td className="px-4 py-3">
                    ...
                    {routine.description && (
                      <p className="text-xs text-[var(--color-muted-foreground)] mt-0.5 line-clamp-1">{routine.description}</p>
                    )}
                  </td>
                  ...
                  <td className="px-4 py-3 hidden lg:table-cell">
                    {routine.is_template ? (
                      <span className="text-xs font-medium text-[var(--color-coach)] bg-[var(--color-coach-light)] px-2 py-0.5 rounded-md">
                        Plantilla
                      </span>
                    ) : (
