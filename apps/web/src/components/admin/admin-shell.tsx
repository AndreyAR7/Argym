      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="md:hidden flex items-center gap-3 px-4 h-14 border-b border-[var(--color-border)] bg-[var(--color-card)] flex-shrink-0">
          <button
            ...
            className="w-9 h-9 flex items-center justify-center rounded-lg text-[var(--color-foreground)] hover:bg-[var(--color-muted)] active:bg-[var(--color-muted)] transition-colors"
          >
            <Menu size={20} />
          </button>
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm tracking-tight text-[var(--color-foreground)]">
              ARGYM Admin
            </span>
          </div>
        </header>
